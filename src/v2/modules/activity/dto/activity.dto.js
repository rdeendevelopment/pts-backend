...
function toActiveTimerDto(timer) {
  ...
  return {
    ...
    autoStopped: Boolean(doc.autoStopped),
    autoStopReason: doc.autoStopReason || null,
    autoStoppedAt: doc.autoStoppedAt || null,
    reviewResolvedAt: doc.reviewResolvedAt || null,
    reviewResolvedBy: doc.reviewResolvedBy ? String(doc.reviewResolvedBy) : null,
    correctedEndAt: doc.correctedEndAt || null,
