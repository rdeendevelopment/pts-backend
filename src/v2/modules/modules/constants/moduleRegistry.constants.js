...
const CORE_MODULE_KEYS = ['dashboard', 'users', 'clients', 'projects', 'activity', 'daily_flow'];

const OPTIONAL_FEATURE_MODULE_KEYS = ['tasks', 'converse', 'clock_activity', 'discuss_flow'];
